...
namespace BotApp.Scorables
{
    public class ViewBranchScorable : ScorableBase<IActivity, string, double>
    {
        ...
        public ViewBranchScorable(IDialogTask task, IDialogFactory dialogFactory)
        {
        ...
        protected override async Task<string> PrepareAsync(IActivity activity, CancellationToken token)
        {
            ...
            {
                if (message.Text.Equals(BotAssets.Commands.ViewBranches, StringComparison.InvariantCultureIgnoreCase))
                { return message.Text; }
            }
        ...
        protected override async Task PostAsync(IActivity item, string state, CancellationToken token)
        {
            ...
            if (message != null)
            {
                var dialog = _dialogFactory.Create<ViewBranchesDialog>();
