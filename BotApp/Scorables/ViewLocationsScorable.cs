...
{
    public class ViewLocationsScorable : ScorableBase<IActivity, string, double>
    {
        private readonly IDialogFactory _dialogFactory;
        private readonly IDialogTask _task;

        public ViewLocationsScorable(IDialogTask task, IDialogFactory dialogFactory)
        {
        ...
        protected override async Task<string> PrepareAsync(IActivity activity, CancellationToken token)
        {
            ...
            {
                if (message.Text.Equals(BotAssets.Commands.ViewLocations, StringComparison.InvariantCultureIgnoreCase))
                { return message.Text; }
            }
        ...
        protected override async Task PostAsync(IActivity item, string state, CancellationToken token)
        {
            ...
            if (message != null)
            {
                var dialog = _dialogFactory.Create<ViewLocationsDialog>();
